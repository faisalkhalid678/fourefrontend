...
const MyDocument = ({ bookingData, firstSegment, lastSegment, originCity, destinationCity, totalStops, totalFlightTime, round, ticketing }) => (
    <Document>
        <Page size="A4" style={{ paddingTop: 25, paddingBottom: 25, paddingLeft: 25, paddingRight: 25 }}>
            ...
            <View style={styles.head}>
                ...
                <View style={styles.PAXInfo}>
                    <Text style={styles.left}>Passenger: {bookingData.data.passenger_detail[0].title + ". " + bookingData.data.passenger_detail[0].name}</Text>
                    {
                                    ...
                                    bookingData.data.passenger_detail.map((pax) => {
                                        return (
                                            <View style={styles.tableRow} key={Math.random()}>
                                                <View style={styles.tableCol}>
                                                    <Text style={styles.tableCell}>{pax.title + '. ' + pax.name}</Text>
                                                </View>
                                                <View style={styles.tableCol}>
                                                    {
                                                        (pax.ticket_number !== '') ?
                                                            <Text style={styles.tableCell}>{pax.ticket_number}</Text>
                                                        :
