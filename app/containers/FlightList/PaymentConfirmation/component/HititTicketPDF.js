...
const MyDocument = ({bookingData, creationDate, totalStops, QueryCity, round, firstSegment, lastSegment, InvoiceData}) => (
    <Document>
                        ...
                        return(
                            <View style={styles.flightsParent} key={Math.random()}>
                                ...
                                <View style={styles.tableParent}>
                                    ...
                                    <Text style={styles.service}>Class of Service: {bookingData.data.cabinClass[0].cabin}</Text>
